      ...
      messages: [
        {
          role: "system",
          content:
            "You are a helpful assistant that analyzes PDF documents and provides structured summaries.",
        },
        {
          role: "user",
...
app.post(
  ...
  async (req, res) => {
    try {
      ...
      const searchQuery =
        req.body.searchQuery || pdfData.text.substring(0, 200);
